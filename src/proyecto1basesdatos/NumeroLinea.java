 ...
 * NumeroLineaModel provided, this component will draw the line numbers as needed.
...
public class NumeroLinea extends JComponent{
	...
	private NumeroLineaModel lineNumberModel;
	...
	public NumeroLinea(NumeroLineaModel model){

		this();

		setNumeroLineaModel(model);
	 ...
	 * Sets the NumeroLineaModel

	 * @param model

	 */

	public void setNumeroLineaModel(NumeroLineaModel model){
